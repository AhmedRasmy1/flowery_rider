...
String pendingOrdersResponseToJson(PendingOrdersResponse data) => json.encode(data.toJson());
...
class PendingOrdersResponse {
    ...
    factory PendingOrdersResponse.fromJson(Map<dynamic, dynamic> json) => PendingOrdersResponse(
...
enum ProductId { THE_673_E1_CD711599201718280_FB, THE_6745096_C90_AB40_A0685402_FC, THE_6745129_A90_AB40_A068540353 }
...
enum ImgCover { FEFA790_A_F0_C1_42_A0_869934_E8_FC065812_COVER_IMAGE_PNG, THE_336_D4_A68_109_D_4_F29_A35_C_D5_CA2215_B4_FF_COVER_IMAGE_PNG, THE_7_A2_F7_D11_FD7_D_4_F85_9_CB7_5_E6_CABD475_BC_COVER_IMAGE_PNG }

final imgCoverValues = EnumValues({
    "fefa790a-f0c1-42a0-8699-34e8fc065812-cover_image.png": ImgCover.FEFA790_A_F0_C1_42_A0_869934_E8_FC065812_COVER_IMAGE_PNG,
    "336d4a68-109d-4f29-a35c-d5ca2215b4ff-cover_image.png": ImgCover.THE_336_D4_A68_109_D_4_F29_A35_C_D5_CA2215_B4_FF_COVER_IMAGE_PNG,
    "7a2f7d11-fd7d-4f85-9cb7-5e6cabd475bc-cover_image.png": ImgCover.THE_7_A2_F7_D11_FD7_D_4_F85_9_CB7_5_E6_CABD475_BC_COVER_IMAGE_PNG
});

enum Occasion { THE_673_B34_C21159920171827_AE0, THE_673_B351_E1159920171827_AE5 }
...
enum Slug { WDDING_FLOWER, FOREVER_PINK_OR_BABY_ROSES, EMOTIONAL_MOMENTS_BOUQUET_OR_25_CHRYSANTHEMUM }

final slugValues = EnumValues({
    "emotional-moments-bouquet-or-25-chrysanthemum": Slug.EMOTIONAL_MOMENTS_BOUQUET_OR_25_CHRYSANTHEMUM,
    "forever-pink-or-baby-roses": Slug.FOREVER_PINK_OR_BABY_ROSES,
    "wdding-flower": Slug.WDDING_FLOWER
});

enum Title { WDDING_FLOWER, FOREVER_PINK_BABY_ROSES, EMOTIONAL_MOMENTS_BOUQUET_25_CHRYSANTHEMUM }

final titleValues = EnumValues({
    "Emotional Moments Bouquet | 25 Chrysanthemum": Title.EMOTIONAL_MOMENTS_BOUQUET_25_CHRYSANTHEMUM,
...
final latLongValues = EnumValues({
    "37.7749,-122.4194": LatLong.THE_3777491224194
});

enum Name { ELEVATE_FLOWER_APP_STORE }

final nameValues = EnumValues({
    "Elevate FlowerApp Store": Name.ELEVATE_FLOWER_APP_STORE
});
...
enum UserId { THE_678_A783_D3_C3797492747_C8_E6, THE_673_A676_F1159920171827_A5_D }
...
final lastNameValues = EnumValues({
    "magdy ": LastName.MAGDY,
    "Tech": LastName.TECH
});

enum Photo { DEFAULT_PROFILE_PNG, THE_087_D7961_C14_B_409_E_AAD8_2_BB84196_F9_E7_UNNAMED_PNG }

final photoValues = EnumValues({
    "default-profile.png": Photo.DEFAULT_PROFILE_PNG,
    "087d7961-c14b-409e-aad8-2bb84196f9e7-unnamed.png": Photo.THE_087_D7961_C14_B_409_E_AAD8_2_BB84196_F9_E7_UNNAMED_PNG
});
