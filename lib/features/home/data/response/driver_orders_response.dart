...
DriverOrdersResponse driverOrdersResponseFromJson(String str) => DriverOrdersResponse.fromJson(json.decode(str));

String driverOrdersResponseToJson(DriverOrdersResponse data) => json.encode(data.toJson());
...
class DriverOrdersResponse {
    ...
    factory DriverOrdersResponse.fromJson(Map<dynamic, dynamic> json) => DriverOrdersResponse(
